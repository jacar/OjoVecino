...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col selection:bg-blue-100 selection:text-blue-900">
      ...
      {/* Main View Container (Mobile App Responsive with Safe Clearance) */}
      <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 pt-3 sm:pt-6 pb-28 md:pb-8 overflow-x-hidden">
